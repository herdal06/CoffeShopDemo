...
public class SRJKPSPublicSoap
{
    ...
    public SRJKPSPublicSoap(){}

    public SRJKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public SRJKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        SRJExtendedSoapSerializationEnvelope envelope= new SRJExtendedSoapSerializationEnvelope(SRJExtendedSoapSerializationEnvelope.VER11);

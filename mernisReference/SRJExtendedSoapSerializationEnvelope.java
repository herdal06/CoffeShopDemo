...
public class SRJExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(SRJDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new SRJStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static SRJDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static SRJDateTimeConverter dateTimeConverter = new SRJStandardDateTimeConverter();

    public SRJExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public SRJExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new SRJMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=SRJHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,SRJExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=SRJHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
